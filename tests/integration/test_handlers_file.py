...
class TestFileDownloadHandler:
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_fetch_disabled_source(
            self,
            mock_ensure_dirs,
            sample_global_config):
    ...
    def test_fetch_single_zip_file(
            self,
            mock_extract_zip,
            mock_download,
            mock_ensure_dirs,
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_fetch_gpkg_source_detection(
            self,
            mock_ensure_dirs,
            sample_gpkg_source,
            sample_global_config):
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_fetch_multi_file_source(
            self,
            mock_ensure_dirs,
            sample_multi_file_source,
            sample_global_config):
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_fetch_source_with_no_url(
            self, mock_ensure_dirs, sample_global_config):
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_handler_with_empty_global_config(
            self, mock_ensure_dirs, sample_file_source):
    ...
    @pytest.mark.integration
    @patch('etl.handlers.file.ensure_dirs')
    def test_handler_with_none_global_config(
            self, mock_ensure_dirs, sample_file_source):
