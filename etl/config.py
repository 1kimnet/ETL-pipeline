...
class ConfigManager:
    ...
    def load_global_config(
            self,
            config_path: Optional[Path] = None) -> GlobalConfig:
    ...
    def load_sources_config(
            self,
            sources_path: Optional[Path] = None) -> List[SourceConfig]:
    ...
    def _apply_environment_overrides(
            self, config_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _create_global_config(
            self, config_dict: Dict[str, Any]) -> GlobalConfig:
    ...
    def _create_source_config(
            self, source_dict: Dict[str, Any]) -> SourceConfig:
