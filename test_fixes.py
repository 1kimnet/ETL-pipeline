...
def test_thread_safety_fix():
    ...
    class MockFileDownloader:
        ...
        def download_files_concurrent(self, handler, file_stems, fail_fast=False, max_workers=None):
            ...
            print(f"  🚀 Using {effective_workers} workers (passed as parameter, not mutating singleton)")
    ...
    class MockSession:
        ...
        def request(self, method, url, **kwargs):
            ...
            if 'timeout' not in kwargs and hasattr(self, '_etl_timeout'):
                ...
                print(f"  ⚠️  Timeout already specified: {kwargs.get('timeout')}s")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("2. ✅ HTTP timeout: Override session.request to ensure timeout is always passed") 
